...
########################################################
## In a powersell-enabled terminal
## Step 1. Ensure correct subscriptionName above and set your favorite cicdSpnName above
#az login
#az account list
## find the corect one
#az account set --subscription $mySpetlrAzureSubscription

## This script uses several custom functions that are located in the .github/deploy/Utilities folder.
## Make sure your powersell terminal are loaded with those functions before running this script,
